...
export default function ApplicationDetailScreen() {
  ...
  const handleCloseModal = () => setQrModalVisible(false);
  ...
  const formattedPeriod = formatPeriod(data.startDate, data.endDate);
  const timerLabel =
          ...
          <View style={styles.body}>
            <TouchableOpacity
              ...
              <TouchableOpacity
                ...
                disabled={isIssuing}>
                <Text variant="labelM" color="#FFFFFF">
                  {isIssuing ? '발급 중...' : isExpired ? 'QR 재발급' : '새로고침'}
                </Text>
              </TouchableOpacity>
            </TouchableOpacity>
      ...
      <Modal
        ...
        <Pressable style={styles.modalBackdrop} onPress={handleCloseModal}>
          <View style={styles.modalContent}>
            ...
            <Text variant="bodyM" color="#6B7280" style={styles.modalHint}>
              화면을 탭하면 닫혀요
            </Text>
          </View>
        </Pressable>
